...
export default function Loading() {
  return <>
    <div className="preloader col-span-12 flex-col justify-center items-center">
	<svg className="cart" role="img" ariaLabel="Shopping cart line animation" viewBox="0 0 128 128" width="128px" height="128px" xmlns="http://www.w3.org/2000/svg">
